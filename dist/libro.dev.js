...
function grabarComentarios(pedido, respuesta) {
  ...
  pedido.on('end', function () {
    ...
    var pagina = "<!doctype html><html><head></head><body>\n                Nombre:".concat(formulario['nombre'], "<br>\n                Codigo:").concat(formulario['comentarios'], "<br>\n                <a href=\"index.html\">Retornar</a>\n                </body></html>");
...
function grabarEnArchivo(formulario) {
  ...
  var datos = "nombre: ".concat(formulario['nombre'], "\n               Codigo:").concat(fecha, ",").concat(formulario['comentarios']);
